...
var etcdclustersResource = schema.GroupVersionResource{Group: "etcd.tkestack.io", Version: "v1alpha1", Resource: "etcdclusters"}

var etcdclustersKind = schema.GroupVersionKind{Group: "etcd.tkestack.io", Version: "v1alpha1", Kind: "EtcdCluster"}
